...
export class PaymentsService {
    ...
    async createPayment(
        ...
        if (!config.credentials) throw new Error("Provider credentials not configured");
    ...
    async findPaymentByProviderTxnId(providerPaymentId: string): Promise<Payment | null> {
    ...
    async updatePaymentStatus(payment: Payment, status: PaymentStatus, metadata?: any) {
